    ...
    return(
        <>
         <section id="about" className="relative z-30 px-4 md:px-10 py-16 md:py-24">
                {/* Hands */}
                <img data-aos="fade-right" src="/images/lefthand.png" alt="Left hand" className="hidden md:block absolute left-0 -top-60 opacity-80 select-none pointer-events-none" />
                <img data-aos="fade-left" src="/images/Righthand.png" alt="Right hand" className="hidden md:block absolute right-0 bottom-[-40px] opacity-80 select-none pointer-events-none" />

                {/* Cards Row */}
                <motion.div 
                whileHover={{scale:1.1}}
                data-aos="zoom-in" className="relative mx-auto  flex items-center justify-center gap-4 sm:gap-6 md:gap-10 ">

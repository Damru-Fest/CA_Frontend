...
export default function Home() {
  ...
  return (
    <>
      <div className="absolute inset-0 h-screen md:h-screen ambassador-home-bg"></div>
      ...
      <main className="relative z-20 -top-6 md:-top-30 flex flex-col items-center justify-center min-h-[60vh] md:min-h-[80vh] px-4 md:px-8 pointer-events-auto">
        ...
        <div className="text-center -mt-2 md:-mt-4 px-2" data-aos="fade-in">
          <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold leading-tight md:leading-[1.15] lg:leading-[1.1] tracking-tight">
            <div className="text-xl md:text-3xl mt-2 ambassador-title-pujarelah">
              Become a
            </div>
            <div className="text-4xl sm:text-6xl md:text-6xl lg:text-[6rem] ambassador-title-montserrat">
              CAMPUS
            </div>
            <div className="text-4xl sm:text-6xl md:text-6xl lg:text-[6rem] ambassador-title-montserrat">
              AMBASSADOR
            </div>
            <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl mb-2 ambassador-title-pujarelah">
              For Damru'25
            </div>
          </h1>
        </div>
        ...
        <p
          data-aos="fade-in"
          className="text-white text-base sm:text-lg md:text-xl text-center mb-8 md:mb-6 max-w-sm sm:max-w-xl md:max-w-3xl ambassador-main-content"
        >
          Represent your campus and unlock exclusive benefits like certificates,
          pronite tickets and more.
        </p>

        {/* Apply Now Button */}
        <Link href="ambassadorForm">
          <motion.button
            className="mx-6 md:mx-10 ambassador-apply-button"

...
const BenefitsSection = () => {
  return (
    <section className="bg-black text-white w-full py-20 px-4 sm:px-6 lg:px-8 ">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto font-['Montserrat']">
            Being a Campus Ambassador comes with its own set of exclusive rewards and opportunities.
          </p>
        </motion.div>
            ...
            >
              ...
              <ul className="space-y-3 text-gray-300">
                {benefit.points.map((point, i) => (
                  <li key={i} className="flex items-start font-['Montserrat'] gap-3">
                    <CheckCircle2 size={20} className="text-[#FF931E] flex-shrink-0 mt-1" />
                    <span>{point}</span>
                  </li>
                ))}
              </ul>

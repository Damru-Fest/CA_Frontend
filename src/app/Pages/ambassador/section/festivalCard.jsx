    ...
    <>
      ...
      >
        ...
        <img
          ...
          src={leftHandImage}
          alt="Decorative hand pointing from top left"
          className="absolute top-0 left-0 w-1/4 max-w-xs md:max-w-md lg:max-w-lg -translate-x-1/4 -translate-y-1/4 pointer-events-none z-0 -rotate-10" // Lowered z-index
        />
        <img
          ref={rightHandRef}
          src={rightHandImage}
          alt="Decorative hand pointing from bottom right"
          className="absolute bottom-0 right-0 w-1/5 pointer-events-none z-0" // Lowered z-index
        />

...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Main Content */}
      <main className="hidden relative z-20 -top-6 md:-top-30 lg:flex flex-col items-center justify-center min-h-[60vh] md:min-h-[80vh] px-4 md:px-8 pointer-events-auto">
        {/* Central Graphic */}

...
const GoogleIconSVG = ({ className }) => (
  ...
  >
    ...
    <path
      fill="#4CAF50"
      d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.223,0-9.649-3.657-11.303-8H6.306C9.663,35.663,16.318,44,24,44z"
    />
    <path
      fill="#1976D2"
  ...
  return (
    ...
    >
      <img
        ...
        className="absolute -top-40 -rotate-2 left-0 w-full h-auto opacity-60"
      />
      ...
      <main className="relative z-30 flex flex-col lg:flex-row items-center justify-center w-full max-w-6xl gap-8 lg:gap-16">
        ...
        <div className="flex flex-col items-center text-center lg:w-1/2">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-wider mt-4">
            CAMPUS AMBASSADOR
          </h1>
        ...
        <div className="w-full max-w-md lg:w-1/3 bg-black/70 backdrop-blur-sm border border-gray-600 rounded-2xl p-6 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-3" noValidate>
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-gray-800/50 border border-gray-600 rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
              {errors.fullName && (
            ...
            <div>
              <div className="flex items-start space-x-3 pt-1">
                <input
                  ...
                  className="h-4 w-4 mt-0.5 rounded border-gray-500 bg-gray-700 text-blue-500 focus:ring-blue-600"
                />
            ...
            <button
              type="submit"
              className="w-full bg-white text-black font-bold rounded-full py-2.5 mt-4 hover:bg-gray-200 transition"
            >
              Sign Up
            </button>
          </form>
